...
% in separate .txt file, otherwise, use find_onset_times.m **
...
% 
% May 16, 2021, updated output filename to match with that generated by
% 'onset_times_events.m'
%---------------------------------------------------------------------------
%---------------------------------------------------------------------------
% BEGIN USER INPUT
...
% 'ext' is added to output name to indicate that it's obtained from
% 'onset_times_events_extract.m'
filename_output_ext = ['find_onset_times_extract_sub', subnum, '.mat'];  
...
if op_results == 1
    % 'ext' is added to indicate results generated by
    % 'onset_times_events_extract.m', while the output filename without
    % 'ext' is added to match with filename produced by
    % 'onset_times_events.' (They contain the same struct, just different
    % filenames)
    save(fullfile(directname_output,filename_output_ext),'terms');

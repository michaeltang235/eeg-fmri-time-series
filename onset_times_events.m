...
% (i) DIRECTNAME is the directory of event details file, 
% (ii) EVFILENAMEe is filename of event details (*.ev2 files), 
% (iii) SAMEFREQ is sampling freq., 
% (iv) EVENTS is array(s) of event types interested, and 
% (v) FMRI_TRIGGER is time in seconds when the first fmri frame was acquired (optional)

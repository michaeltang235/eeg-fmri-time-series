...
% and generates,
% ch_list = array of ied onset and propagtion channels, its format is given
% below, 
...
function ch_list = get_ied_onset_ied_propa_ch(subnum)

% initialize output array as empty, details of its format is given below
ch_list = {};

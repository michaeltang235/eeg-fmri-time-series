...
% (i) fname = directory of files where info. about electrodes and spike rates
% are found
% (ii) filename_elect = filename of file containing info. about electrodes
% (iii) filename_spikes = filename of file containing info. about spike
% rates
% (iv) fname1 = directory of files where spm output is located at
% (v) filename_spmT = filename of files containing info. about spmT matrix
